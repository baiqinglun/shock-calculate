...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "1.9.4"
  WORKING_DIRECTORY "E:/Programming/c++/H2-shock/cmake-build-debug/_deps/jsoncpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/Programming/c++/H2-shock/cmake-build-debug/_deps/jsoncpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Programming/c++/H2-shock/cmake-build-debug/_deps/jsoncpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
